...
<?php if ($all_post_datas['metabox_posts_header_img_display'] == 1){ ?>
    ...
    <?php if ( $all_post_datas['metabox_posts_header_img']['url'] == "" ){ $all_post_datas['metabox_posts_header_img']['url'] = ''; } ?>

    <section id="nicdark_singlepost_parallax" class="nicdark_section nicdark_imgparallax" style="background:url(<?php echo esc_url( $all_post_datas['metabox_posts_header_img']['url']); ?>) 50% 0 fixed; background-size:cover;">
