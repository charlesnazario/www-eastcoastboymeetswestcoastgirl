...
<?php if ($all_product_datas['metabox_products_header_img_display'] == 1){ ?>
    ...
    <section id="nicdark_singlepost_parallax" class="nicdark_section nicdark_imgparallax" style="background:url(<?php echo $all_product_datas['metabox_products_header_img']['url']; ?>) 50% 0 fixed; background-size:cover;">
