...
function nicdark_register_required_plugins() {
    ...
    $plugins = array(
        ...
        // RevSlider
        array(
            'name'               =>  __('Revolution Slider','weddingcouple'), // The plugin name.
            'slug'               => 'revslider', // The plugin slug (typically the folder name).
            'source'             => esc_url('http://www.nicdarkthemes.com/themes/wedding-couple/wp/plugins/revslider.zip'), // The plugin source.
        ...
        // Contact Form 7
        array(
            'name'               =>  __('Contact Form 7','weddingcouple'), // The plugin name.
            'slug'               => 'contact-form-7', // The plugin slug (typically the folder name).
            'source'             => esc_url('http://www.nicdarkthemes.com//themes/wedding-couple/wp/plugins/contact-form-7.zip'), // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        // WordPress Importer
        array(
            'name'               =>  __('WordPress Importer','weddingcouple'), // The plugin name.
            'slug'               => 'wordpress-importer', // The plugin slug (typically the folder name).
            'source'             => esc_url('http://www.nicdarkthemes.com/themes/wedding-couple/wp/plugins/wordpress-importer.zip'), // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            'name'               =>  __('WPBakery Visual Composer','weddingcouple'), // The plugin name.
            'slug'               => 'js_composer', // The plugin slug (typically the folder name).
            'source'             => esc_url('http://www.nicdarkthemes.com/themes/wedding-couple/wp/plugins/js_composer_wp.zip'), // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        // Nicdark Shortcodes
        array(
            'name'               =>  __('Nicdark Shortcodes','weddingcouple'), // The plugin name.
            'slug'               => 'nicdark-shortcodes', // The plugin slug (typically the folder name).
            'source'             => esc_url('http://www.nicdarkthemes.com/themes/wedding-couple/wp/plugins/nicdark-shortcodes.zip'), // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        // Woo Commerce
        array(
            'name'               =>  __('Woo Commerce','weddingcouple'), // The plugin name.
            'slug'               => 'woocommerce', // The plugin slug (typically the folder name).
            'source'             => esc_url('http://www.nicdarkthemes.com/themes/wedding-couple/wp/plugins/woocommerce.zip'), // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'installing'                      => __( 'Installing Plugin: %s', 'weddingcouple' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'weddingcouple' ),
            ...
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'weddingcouple' ), // %s = dashboard link.
...
function nicdark_register_my_menus() {
  register_nav_menu( 'main-menu', __( 'Main Menu', 'weddingcouple' ) );  
}
...
function add_nicdark_sidebars() {
    ...
    // Sidebar Second
    register_sidebar(array(
        'name' =>  __('Sidebar Second','weddingcouple'),
        'id' => 'sidebar-second',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2>',
...
function nicdark_hide_taxonomy_inpost() {
  echo '<style> #menu-posts-vc_grid_item { display:none; }</style>';
}
