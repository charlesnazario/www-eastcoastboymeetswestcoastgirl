	    ...
	    <div class="nicdark_filter <?php echo esc_attr($redux_demo['archive_post_header_filter']); ?>">
	        ...
	        <div class="nicdark_container nicdark_clearfix">
	            ...
	            <div class="grid grid_12">
	                ...
	                <?php if (is_category()): ?>
						<h1 class="center white extrasize title"><?php _e('CATEGORY','weddingcouple'); ?></h1><div class="nicdark_space10"></div><h3 class="center subtitle white"><?php single_cat_title(); ?></h3>
					<?php elseif (is_tag()): ?>
						<h1 class="center white extrasize title"><?php _e('TAG','weddingcouple'); ?></h1><div class="nicdark_space10"></div><h3 class="center subtitle white"><?php single_tag_title() ?></h3>
					<?php elseif (is_month()): ?>
						<h1 class="center white extrasize title"><?php _e('ARCHIVE FOR','weddingcouple'); ?></h1><div class="nicdark_space10"></div><h3 class="center subtitle white"><?php single_month_title(); ?></h3>
					<?php elseif (is_author()): ?>
						<h1 class="center white extrasize title"><?php _e('AUTHOR','weddingcouple'); ?></h1><div class="nicdark_space10"></div><h3 class="center subtitle white"><?php the_author(); ?></h3>
					<?php elseif (is_search()): ?>
						<h1 class="center white extrasize title"><?php _e('SEARCH FOR','weddingcouple'); ?></h1><div class="nicdark_space10"></div><h3 class="center subtitle white">" <?php the_search_query(); ?> "</h3>
					<?php else: ?>
						<h1 class="center white extrasize title"><?php _e('ARCHIVE','weddingcouple'); ?></h1>
					<?php endif ?>
    ...
    <div class="nicdark_container nicdark_clearfix">
	    	...
	    	<div class="grid grid_8">
					...
					<?php while(have_posts()) : the_post(); ?>
						...
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					            ...
					            <div class="nicdark_focus nicdark_border_grey nicdark_sizing nicdark_padding20">
					            	...
					            	<p><?php the_excerpt(); ?></p>
					            	<div class="nicdark_space20"></div>
					            	<a class="nicdark_btn nicdark_press nicdark_bg_<?php echo esc_attr($redux_demo['metabox_posts_color']); ?> white medium  " href="<?php esc_url(the_permalink()); ?>"><?php _e('READ MORE','weddingcouple'); ?></a>
								</div>
								<!--END PREVIEW-->
				...
				<?php else: ?>
					...
					<?php $nicdark_search_message = __('NOTHING FOUND: Search again','weddingcouple'); ?>
