...
<?php if ($redux_demo['metabox_pages_header_img_display'] == 1){ ?>
    ...
    <div id="nicdark_singlepage_parallax" class="nicdark_section nicdark_imgparallax" style="background:url(<?php echo esc_url( $redux_demo['metabox_pages_header_img']['url'] ); ?>) 50% 0 fixed; background-size:cover;">
