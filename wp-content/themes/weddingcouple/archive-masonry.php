		...
		<?php while(have_posts()) : the_post(); ?>
			...
			<div class="grid grid_4 nicdark_masonry_item nicdark_width100_ipadpotr">
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<div class="nicdark_focus nicdark_padding40 nicdark_sizing" style="background-image:url(<?php echo esc_url($image_attributes[0]); ?>); background-size:cover;">
			            <div class="nicdark_focus nicdark_filter white nicdark_padding40 nicdark_sizing center">
			                ...
			                <p><?php the_excerpt(); ?></p>
			                <div class="nicdark_space20"></div>
			                <a href="<?php esc_url(the_permalink()); ?>" class="nicdark_btn nicdark_border_grey nicdark_press nicdark_transition title medium grey"><?php _e('READ MORE','weddingcouple'); ?></a>
			            </div>
			        </div>
		        </div>
				<!--#post-->
