...
<div class="nicdark_focus">
    <?php $args = array(
		'before'           => '<p>' . __('Pages:', 'weddingcouple'),
		'after'            => '</p>',
		'link_before'      => '',
		'link_after'       => '',
		'next_or_number'   => 'number',
		'nextpagelink'     => __('Next page', 'weddingcouple'),
		'previouspagelink' => __('Previous page', 'weddingcouple'),
		'pagelink'         => '%',
		'echo'             => 1
	); ?>
...
<?php if ($redux_demo['metabox_posts_categories'] == 1) { ?> 
    ...
    <div class="nicdark_textevidence nicdark_bg_grey nicdark_border_grey nicdark_sizing ">
        <div class="nicdark_margin20">
            <p style="color:#a4a4a4;"><?php _e('Category','weddingcouple'); ?>: <?php the_category(", ");?></p>
       </div>
       <!--<i class="icon-tags-1 nicdark_iconbg right big grey"></i>-->
    </div>
    <div class="nicdark_space10"></div>
