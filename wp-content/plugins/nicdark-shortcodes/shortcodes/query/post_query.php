...
if ($atts['show_filter'] == 1) {
  ...
  $str .= '<div class="nicdark_masonry_btns"><div class="nicdark_margin10"><a data-filter="*" class="  nicdark_btn nicdark_bg_blue small   white">'.$nicdark_text_postquery_all.'</a></div>';
...
while ( $the_query->have_posts() ) : $the_query->the_post();
    ...
    if ( $atts['post_grid_posts_layout'] == 'post_layout_2' ) {
      include 'layout_posts/layout_2.php';
    }elseif ( $atts['post_grid_posts_layout'] == 'post_layout_3' ) {
      include 'layout_posts/layout_3.php'; 
    }else{
