...
{  
  ...
  $imgsrc = wp_get_attachment_image_src($atts['image'],'large');
   ...
   $str .= '
    ...
    <div class="nicdark_archive1 center nicdark_bg_'.$atts['color'].'dark  ">
                ...
                <div class="nicdark_textevidence nicdark_bg_white nicdark_border_grey nicdark_sizing">
                    <div style="display:block;" class="nicdark_margin20 nicdark_archive1_content">'.$atts['text'].'</div>
                </div>

                <a target="'.$a_target.'" href="'.$a_href.'" class="white nicdark_btn nicdark_bg_'.$atts['color'].'dark big nicdark_radius_bottom">'.$a_title.'</a>
